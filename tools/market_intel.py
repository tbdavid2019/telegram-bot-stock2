...
REQUEST_HEADERS = {"User-Agent": "telegram-bot-stock2/2.4", "Accept": "application/json"}
READER_HEADERS = {"User-Agent": "telegram-bot-stock2/2.4", "Accept": "text/plain"}
...
def _twomd_read(url: str) -> str:
    """Read a source URL through every 2MD node, returning plain text."""
    if not url:
        return ""
